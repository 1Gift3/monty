...
/**
 * parse_line - Separates every line into tokens to determine
 * which function to call
 * @buffer: Line from the file
 * @line_number: Line number
 * @format:  storage format. If 0 Nodes will be entered as a stack.
 * if 1 nodes will be entered as a queue.
 * Return: Returns NULL if the opcode is stack. 1 if queue.
 */
 ...
 * @format:  storage format. If NULL Nodes will be entered as a stack.
 * @ln: line number
 * if 1 nodes will be entered as a queue.
 * Return: void
 */
