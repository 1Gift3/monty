...
/**
 * rotl - Circulates the first node of stack to the bottom.
...
/**
 * rotr - Rotates last node of the stack to top.
 * @stack: Pointer to pointer pointing the top node of stack.
 * @ln: Interger representing the line number of the opcode.
 */
